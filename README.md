...
* `git clone git@github.com:rumblex/angularattack2016-ghc.git`

* `cd angularattack2016-ghc`
...
If you receive an error message `"You do not have permission to publish to ghc.2016.angularattack.io"`, it might mean another team member has already deployed your project to Surge. Ask them to run the next step to give you access.

### Step 3) Add Your Team Members to Surge

* `surge . --add elthrasher@gmail.com,matt.martz@gmail.com`
