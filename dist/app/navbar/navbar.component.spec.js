...
var NavbarComponentTestController = (function () {
    function NavbarComponentTestController() {
    }
    NavbarComponentTestController = __decorate([
        core_1.Component({
            selector: 'test',
    ...
    ], NavbarComponentTestController);
    return NavbarComponentTestController;
}());
