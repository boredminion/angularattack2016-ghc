...
testing_1.describe('Component: Cell', function () {
    var builder;
    testing_1.beforeEachProviders(function () { return [cell_component_1.CellComponent]; });
    testing_1.beforeEach(testing_1.inject([testing_2.TestComponentBuilder], function (tcb) {
        builder = tcb;
    }));
    testing_1.it('should inject the component', testing_1.inject([cell_component_1.CellComponent], function (component) {
